...
class DotControllerCalendarTile extends StatelessWidget {
  const DotControllerCalendarTile({super.key, required this.dotControllerModel});
  ...
  Widget build(BuildContext context) {
    ...
    final fontSizeTitle = screenSize.height * 0.020;
    ...
    return  Padding(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          title: Text('Wynik: ${dotControllerModel.score} punkty', style: TextStyle(fontSize: fontSizeTitle),),
          subtitle: Text('Wkazano poprawnie $correctDots z ${dotControllerModel.controlledDots} \n'
                         'Czas gry: $time s \n',
